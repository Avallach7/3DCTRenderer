...
namespace Ct3dRenderer.Gui
{
	public class HudFps : MonoBehaviour
	{
		...
		{
			UnityEngine.GUI.Label(new Rect(0, 0, startRect.width, startRect.height), sFPS + " FPS", style);
			if (allowDrag) UnityEngine.GUI.DragWindow(new Rect(0, 0, Screen.width, Screen.height));
		}
	}
}